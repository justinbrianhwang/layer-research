...
from _common import Run, parser, read_table_columns, table
...
def main():
    ...
    # This control is shared by every budget.
    ...
    for (experiment, fraction, alpha, cap), group in main.groupby(["experiment", "fraction", "alpha", "norm_cap"], dropna=False, observed=True):
        print(f"observed validation: {experiment}, fraction={fraction}, alpha={alpha}, norm_cap={cap}", flush=True)
